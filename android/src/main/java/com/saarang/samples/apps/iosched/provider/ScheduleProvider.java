...
package com.saarang.samples.apps.iosched.provider;

import com.saarang.samples.apps.iosched.appwidget.ScheduleWidgetProvider;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Announcements;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.PeopleIveMet;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Blocks;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Experts;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Feedback;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.MapMarkers;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.MapTiles;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Rooms;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.SearchSuggest;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Sessions;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Speakers;
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Tags;
import com.saarang.samples.apps.iosched.provider.ScheduleDatabase.SessionsSearchColumns;
import com.saarang.samples.apps.iosched.provider.ScheduleDatabase.SessionsSpeakers;
import com.saarang.samples.apps.iosched.provider.ScheduleDatabase.Tables;
import com.saarang.samples.apps.iosched.util.SelectionBuilder;
 ...
 * by {@link com.saarang.samples.apps.iosched.sync.SyncHelper}, and queried by various
