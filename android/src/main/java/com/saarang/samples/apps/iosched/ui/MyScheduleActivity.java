...
import com.saarang.samples.apps.iosched.ui.widget.MyScheduleView;
...
public class MyScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String TAG = LogUtils.makeLogTag(MyScheduleActivity.class);
    ...
    private static final String ARG_CONFERENCE_DAY_INDEX
            = "com.saarang.samples.apps.iosched.ARG_CONFERENCE_DAY_INDEX";
    ...
    public static final String EXTRA_DIALOG_TITLE
            = "com.saarang.samples.apps.iosched.EXTRA_DIALOG_TITLE";
    public static final String EXTRA_DIALOG_MESSAGE
            = "com.saarang.samples.apps.iosched.EXTRA_DIALOG_MESSAGE";
    public static final String EXTRA_DIALOG_YES
            = "com.saarang.samples.apps.iosched.EXTRA_DIALOG_YES";
    public static final String EXTRA_DIALOG_NO
            = "com.saarang.samples.apps.iosched.EXTRA_DIALOG_NO";
    public static final String EXTRA_DIALOG_URL
            = "com.saarang.samples.apps.iosched.EXTRA_DIALOG_URL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mWideMode) {
            mMyScheduleViewWide[0] = (MyScheduleView) findViewById(com.saarang.samples.apps.iosched.R.id.my_schedule_first_day);
            mMyScheduleViewWide[0].setAdapter(mScheduleAdapters[0]);
            mMyScheduleViewWide[1] = (MyScheduleView) findViewById(com.saarang.samples.apps.iosched.R.id.my_schedule_second_day);
            mMyScheduleViewWide[1].setAdapter(mScheduleAdapters[1]);

            TextView firstDayHeaderView = (TextView) findViewById(com.saarang.samples.apps.iosched.R.id.day_label_first_day);
            TextView secondDayHeaderView = (TextView) findViewById(com.saarang.samples.apps.iosched.R.id.day_label_second_day);
            ...
            mSlidingTabLayout.setCustomTabView(com.saarang.samples.apps.iosched.R.layout.tab_indicator, android.R.id.text1);

            setSlidingTabLayoutContentDescriptions();

            Resources res = getResources();
            mSlidingTabLayout.setSelectedIndicatorColors(res.getColor(com.saarang.samples.apps.iosched.R.color.tab_selected_strip));
    ...
    private void setSlidingTabLayoutContentDescriptions() {
        for (int i = 0; i < Config.CONFERENCE_DAYS.length; i++) {
            mSlidingTabLayout.setContentDescription(i,
                    getString(com.saarang.samples.apps.iosched.R.string.my_schedule_tab_desc_a11y, getDayName(i)));
        }
    }
    ...
    public void onAuthFailure(String accountName) {
        ...
        UIUtils.setUpButterBar(mButterBar, getString(com.saarang.samples.apps.iosched.R.string.login_failed_text),
                getString(com.saarang.samples.apps.iosched.R.string.login_failed_text_retry), new View.OnClickListener() {
                    @Override
        ...
        registerHideableHeaderView(findViewById(com.saarang.samples.apps.iosched.R.id.butter_bar));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.saarang.samples.apps.iosched.R.menu.my_schedule, menu);
    ...
    private final ContentObserver mObserver = new ThrottledContentObserver(
            new ThrottledContentObserver.Callbacks() {
                ...
                public void onThrottledContentObserverFired() {
                    LogUtils.LOGD(TAG, "content may be changed, reloading data");
                    updateData();
                }
            });
