...
public class HashtagsFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final String TAG = LogUtils.makeLogTag(HashtagsFragment.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_hashtags, container, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        mCollectionView = (CollectionView) view.findViewById(com.saarang.samples.apps.iosched.R.id.social_collection_vew);
    }
    ...
    private static class HashtagsAdapter extends CursorAdapter implements CollectionViewCallbacks {
        ...
        public CollectionView.Inventory getInventory() {
            ...
            inventory.addGroup(new CollectionView.InventoryGroup(HashtagsQuery.TOKEN)
                    .setDisplayCols(mContext.getResources().getInteger(com.saarang.samples.apps.iosched.R.integer.social_grid_columns))
        ...
        private View newHeroView(Context context, ViewGroup parent) {
            return LayoutInflater.from(context).inflate(com.saarang.samples.apps.iosched.R.layout.list_item_hashtag_hero, parent, false);
        }

        @Override
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            View view = LayoutInflater.from(context).inflate(com.saarang.samples.apps.iosched.R.layout.list_item_hashtags, parent, false);
            ViewHolder holder = new ViewHolder();
            assert view != null;
            holder.name = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.name);
            holder.description = (ImageButton) view.findViewById(com.saarang.samples.apps.iosched.R.id.description);
            view.setTag(holder);
            return view;
        }
        ...
        public void bindHeroView(View view, Context context, Cursor cursor) {
            ...
            ((TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.name)).setText(hashtag);
