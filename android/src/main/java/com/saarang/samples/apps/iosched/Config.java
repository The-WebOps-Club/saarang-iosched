...
package com.saarang.samples.apps.iosched;
...
public class Config {
    ...
    public static final String DOGFOOD_BUILD_WARNING_TEXT = "This is a double test build.";

    // Public data manifest URL
    public static final String PROD_CONFERENCE_DATA_MANIFEST_URL = "http://erp.saarang.org/static/json/manifest.json";
    ...
    public static final String CONFERENCE_HASHTAG_PREFIX = "#saarang";
