...
public class PartnersFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_partners, container, false);
        if (getArguments() != null && !getArguments().getBoolean(ARG_HAS_HEADER, true)) {
            rootView.findViewById(com.saarang.samples.apps.iosched.R.id.headerbar).setVisibility(View.GONE);
        }

        rootView.findViewById(com.saarang.samples.apps.iosched.R.id.close_button).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mCollectionView = (CollectionView) rootView.findViewById(com.saarang.samples.apps.iosched.R.id.collection_view);
        return rootView;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayCols = getResources().getInteger(com.saarang.samples.apps.iosched.R.integer.partners_columns);
    ...
    private class PartnersAdapter extends CursorAdapter implements CollectionViewCallbacks {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            return LayoutInflater.from(context).inflate(com.saarang.samples.apps.iosched.R.layout.list_item_partner, parent, false);
        }

        @Override
        public void bindView(View view, Context context, Cursor cursor) {
            final String url = mCursor.getString(PartnersQuery.WEBSITE_URL);
            view.findViewById(com.saarang.samples.apps.iosched.R.id.partner_target).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            ImageView imageView = (ImageView) view.findViewById(com.saarang.samples.apps.iosched.R.id.image);
            mImageLoader.loadImage(cursor.getString(PartnersQuery.LOGO_URL), imageView);
            ((TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.name)).setText(cursor.getString(PartnersQuery.NAME));
            ((TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.url)).setText(
                    TRIM_FROM_DISPLAY_URL_PATTERN.matcher(url).replaceAll(""));
            ((TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.desc)).setText(cursor.getString(PartnersQuery.DESC));
        }
