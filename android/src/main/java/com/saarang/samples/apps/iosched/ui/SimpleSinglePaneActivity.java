...
public abstract class SimpleSinglePaneActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getFragmentManager().beginTransaction()
                    .add(com.saarang.samples.apps.iosched.R.id.root_container, mFragment, "single_pane")
                    .commit();
        } else {
    ...
    protected int getContentViewResId() {
        return com.saarang.samples.apps.iosched.R.layout.activity_singlepane_empty;
    }
