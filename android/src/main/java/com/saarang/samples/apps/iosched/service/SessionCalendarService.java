...
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "com.saarang.samples.apps.iosched.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "com.saarang.samples.apps.iosched.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "com.saarang.samples.apps.iosched.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "com.saarang.samples.apps.iosched.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "com.saarang.samples.apps.iosched.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "com.saarang.samples.apps.iosched.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_START =
            "com.saarang.samples.apps.iosched.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_END =
            "com.saarang.samples.apps.iosched.extra.SESSION_BLOCK_END";
    ...
    private String makeCalendarEventTitle(String sessionTitle) {
        return sessionTitle + getResources().getString(com.saarang.samples.apps.iosched.R.string.session_calendar_suffix);
    }

    /**
     * Processes all sessions in the
     * {@link com.saarang.samples.apps.iosched.provider.ScheduleProvider}, adding or removing
