...
package com.saarang.samples.apps.iosched.ui.phone;
...
public class MapActivity extends BaseMapActivity implements MapFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPopupContainerView = findViewById(com.saarang.samples.apps.iosched.R.id.fragment_container_popup);
        ...
        LogUtils.LOGD("Tracker", SCREEN_LABEL);
    ...
    private void updatePopup() {
        View mapContainerView = findViewById(com.saarang.samples.apps.iosched.R.id.fragment_container_map);
    ...
    public void onShowPartners() {
        getFragmentManager().beginTransaction()
                .add(com.saarang.samples.apps.iosched.R.id.fragment_container_popup, PartnersFragment.newInstance(true),
    ...
    protected void showNearbyFragment(String tag) {
        getFragmentManager().beginTransaction()
                .add(com.saarang.samples.apps.iosched.R.id.fragment_container_popup, NearbyFragment.newInstance(true), tag)
                .addToBackStack(null)
                .commit();
    }
}
