...
package com.saarang.samples.apps.iosched.ui.debug.actions;
...
import com.saarang.samples.apps.iosched.ui.debug.DebugAction;
...
public class ShowSessionNotificationDebugAction implements DebugAction {
    ...
    public void run(Context context, Callback callback) {
        ...
        notifBuilder.addAction(com.saarang.samples.apps.iosched.R.drawable.ic_map_holo_dark,
                context.getString(com.saarang.samples.apps.iosched.R.string.title_map),
                piMap);

        NotificationCompat.InboxStyle richNotification = new NotificationCompat.InboxStyle(
                notifBuilder)
                .setBigContentTitle(context.getResources().getQuantityString(com.saarang.samples.apps.iosched.R.plurals.session_notification_title,
                        1,
                        8,
                        1));
