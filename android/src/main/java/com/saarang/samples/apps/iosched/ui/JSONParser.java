...
public class JSONParser {
    ...
    String completeUrl = "http://erp.saarang.org/" + url;
        // Making HTTP request
        try {
    ...
    public JSONObject makeHttpRequest(String url, Boolean SaarangOrNot, String method,
            List<NameValuePair> params, String token) {
        String completeUrl;
        if (SaarangOrNot) {
            completeUrl = "http://erp.saarang.org/" + url;
        }else{
            completeUrl = url;
        }
