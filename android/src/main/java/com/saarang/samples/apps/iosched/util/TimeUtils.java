...
public class TimeUtils {
    ...
    public static String formatHumanFriendlyShortDate(final Context context, long timestamp) {
        ...
        if (dayOrd == nowOrd) {
            return context.getString(com.saarang.samples.apps.iosched.R.string.day_title_today);
        } else if (dayOrd == nowOrd - 1) {
            return context.getString(com.saarang.samples.apps.iosched.R.string.day_title_yesterday);
        } else if (dayOrd == nowOrd + 1) {
            return context.getString(com.saarang.samples.apps.iosched.R.string.day_title_tomorrow);
        } else {
