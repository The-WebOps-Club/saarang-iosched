...
import com.saarang.samples.apps.iosched.provider.ScheduleContract.SyncColumns;
import com.saarang.samples.apps.iosched.util.Lists;
import com.saarang.samples.apps.iosched.util.NetUtils;
...
public class AnnouncementsFetcher {
    private static final String TAG = LogUtils.makeLogTag(AnnouncementsFetcher.class);
