...
public class WiFiUtils {
        ...
        if (netId != -1) {
            ...
            if (!result) {
                ...
                Toast.makeText(context,
                        context.getResources().getString(com.saarang.samples.apps.iosched.R.string.wifi_install_error_message),
    ...
    public static class WiFiDialog extends DialogFragment {
        private static final String ARG_WIFI_ENABLED
                = "com.saarang.samples.apps.iosched.ARG_WIFI_ENABLED";
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            final int padding =
                    getResources().getDimensionPixelSize(com.saarang.samples.apps.iosched.R.dimen.content_padding_normal);
            ...
            if (mWiFiEnabled) {
                dialogCallToActionText = com.saarang.samples.apps.iosched.R.string.calltoaction_wifi_configure;
                dialogPositiveButtonText = com.saarang.samples.apps.iosched.R.string.wifi_dialog_button_configure;
            } else {
                dialogCallToActionText = com.saarang.samples.apps.iosched.R.string.calltoaction_wifi_settings;
                dialogPositiveButtonText = com.saarang.samples.apps.iosched.R.string.wifi_dialog_button_settings;
            }
            wifiTextView.setText(Html.fromHtml(getString(com.saarang.samples.apps.iosched.R.string.description_setup_wifi_body) +
            ...
            return new AlertDialog.Builder(context)
                    .setTitle(com.saarang.samples.apps.iosched.R.string.description_configure_wifi)
