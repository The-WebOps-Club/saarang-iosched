...
public class ScheduleWidgetProvider extends AppWidgetProvider {
    ...
    private static final String REFRESH_ACTION =
            "com.saarang.samples.apps.iosched.appwidget.action.REFRESH";
    private static final String EXTRA_PERFORM_SYNC =
            "com.saarang.samples.apps.iosched.appwidget.extra.PERFORM_SYNC";
    ...
    public void onReceive(final Context context, Intent widgetIntent) {
        ...
        if (REFRESH_ACTION.equals(action)) {
            ...
            mgr.notifyAppWidgetViewDataChanged(mgr.getAppWidgetIds(cn),
                    com.saarang.samples.apps.iosched.R.id.widget_schedule_list);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            final RemoteViews rv = new RemoteViews(context.getPackageName(), com.saarang.samples.apps.iosched.R.layout.widget);
            rv.setRemoteAdapter(com.saarang.samples.apps.iosched.R.id.widget_schedule_list, intent);

            // Set the empty view to be displayed if the collection is empty.  It must be a sibling
            // view of the collection view.
            rv.setEmptyView(com.saarang.samples.apps.iosched.R.id.widget_schedule_list, android.R.id.empty);
            LOGD(TAG, "setting widget empty view");
            rv.setTextViewText(android.R.id.empty, context.getResources().getString(isAuthenticated
                    ? com.saarang.samples.apps.iosched.R.string.empty_widget_text
                    : com.saarang.samples.apps.iosched.R.string.empty_widget_text_signed_out));

            final PendingIntent refreshPendingIntent = PendingIntent.getBroadcast(context, 0,
                    getRefreshBroadcastIntent(context, true), PendingIntent.FLAG_UPDATE_CURRENT);
            rv.setOnClickPendingIntent(com.saarang.samples.apps.iosched.R.id.widget_refresh_button, refreshPendingIntent);
            ...
            rv.setPendingIntentTemplate(com.saarang.samples.apps.iosched.R.id.widget_schedule_list, onClickPendingIntent);
            ...
            rv.setOnClickPendingIntent(com.saarang.samples.apps.iosched.R.id.widget_logo, openAppPendingIntent);
