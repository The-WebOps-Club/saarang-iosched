...
public class MyScheduleAdapter implements ListAdapter, AbsListView.RecyclerListener {
    private static final String TAG = LogUtils.makeLogTag("MyScheduleAdapter");
    private static final int TAG_ID_FOR_VIEW_TYPE = com.saarang.samples.apps.iosched.R.id.myschedule_viewtype_tagkey;
    ...
    public MyScheduleAdapter(Context context, LUtils lUtils) {
        ...
        mDefaultStartTimeColor = mContext.getResources().getColor(com.saarang.samples.apps.iosched.R.color.body_text_2);
        mDefaultEndTimeColor = mContext.getResources().getColor(com.saarang.samples.apps.iosched.R.color.body_text_3);
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        int layoutResId = com.saarang.samples.apps.iosched.R.layout.my_schedule_item;
        if (itemViewType == VIEW_TYPE_NOW) {
            isNowPlaying = true;
            layoutResId = com.saarang.samples.apps.iosched.R.layout.my_schedule_item_now;
        } else if (itemViewType == VIEW_TYPE_PAST_DURING_CONFERENCE) {
            isPastDuringConference = true;
            layoutResId = com.saarang.samples.apps.iosched.R.layout.my_schedule_item_past;
        }
        ...
        if (view == null || !MY_VIEW_TAG.equals(view.getTag())
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Object tag = v.getTag(com.saarang.samples.apps.iosched.R.id.myschedule_uri_tagkey);
                    if (tag != null && tag instanceof Uri) {
                        ...
                        mContext.startActivity(new Intent("com.saarang.samples.apps.iosched.SESSION_VIEW", uri));
                    }
                }
            });
        }
        ...
        startTimeView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.start_time);
        endTimeView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.end_time);
        ImageView bgImageView = (ImageView) view.findViewById(com.saarang.samples.apps.iosched.R.id.background_image);
        final ImageView sessionImageView = (ImageView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_image);
        FrameLayout boxView = (FrameLayout) view.findViewById(com.saarang.samples.apps.iosched.R.id.box);
        TextView slotTitleView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.slot_title);
        TextView slotSubtitleView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.slot_subtitle);
        ImageButton giveFeedbackButton = (ImageButton) view.findViewById(com.saarang.samples.apps.iosched.R.id.give_feedback_button);
        int heightNormal = res.getDimensionPixelSize(com.saarang.samples.apps.iosched.R.dimen.my_schedule_item_height);
        int heightBreak = ViewGroup.LayoutParams.WRAP_CONTENT;
        int heightPast = res.getDimensionPixelSize(com.saarang.samples.apps.iosched.R.dimen.my_schedule_item_height_past);
        ...
        if (item.endTime <= now) {
            // session has ended
            startTimeView.setText(com.saarang.samples.apps.iosched.R.string.session_finished);
        } else if (item.startTime <= now) {
            // session is happening now!
            isBlockNow = true;
            startTimeView.setText(com.saarang.samples.apps.iosched.R.string.session_now);
        ...
        if (endTimeView != null) {
            if (showEndTime) {
                ...
                endTimeView.setText(res.getString(com.saarang.samples.apps.iosched.R.string.schedule_end_time,
        ...
        View conflictWarning =  view.findViewById(com.saarang.samples.apps.iosched.R.id.conflict_warning);
        ...
        view.setTag(com.saarang.samples.apps.iosched.R.id.myschedule_uri_tagkey, null);
        if (item.type == ScheduleItem.FREE) {
            view.getLayoutParams().height = isPastDuringConference ? heightPast : heightNormal;
            boxView.setBackgroundResource(com.saarang.samples.apps.iosched.R.drawable.schedule_item_free);
            boxView.setForeground(res.getDrawable(com.saarang.samples.apps.iosched.R.drawable.schedule_item_touchoverlay_dark));
            bgImageView.setVisibility(View.GONE);
            sessionImageView.setVisibility(View.GONE);
            if (giveFeedbackButton != null) {
                giveFeedbackButton.setVisibility(View.GONE);
            }
            slotTitleView.setText(com.saarang.samples.apps.iosched.R.string.browse_sessions);
            slotTitleView.setTextColor(res.getColor(com.saarang.samples.apps.iosched.R.color.theme_primary));
            ...
            if (slotSubtitleView != null) {
                ...
                slotSubtitleView.setTextColor(res.getColor(com.saarang.samples.apps.iosched.R.color.body_text_2));
            }
            Uri uri = ScheduleContract.Sessions.buildUnscheduledSessionsInInterval(
                    item.startTime, item.endTime);
            view.setTag(com.saarang.samples.apps.iosched.R.id.myschedule_uri_tagkey, uri);

        } else if (item.type == ScheduleItem.BREAK) {
            view.getLayoutParams().height = isPastDuringConference ? heightPast : heightBreak;
            boxView.setBackgroundResource(com.saarang.samples.apps.iosched.R.drawable.schedule_item_break);
            ...
            slotTitleView.setTextColor(res.getColor(com.saarang.samples.apps.iosched.R.color.body_text_1));
            slotTitleView.setTypeface(Typeface.SANS_SERIF, Typeface.NORMAL);
            if (slotSubtitleView != null) {
                slotSubtitleView.setText(item.subtitle);
                slotSubtitleView.setTextColor(res.getColor(com.saarang.samples.apps.iosched.R.color.body_text_2));
            ...
            view.getLayoutParams().height = isPastDuringConference ? heightPast : heightNormal;
            boxView.setBackgroundResource(com.saarang.samples.apps.iosched.R.drawable.schedule_item_session);
            boxView.setForeground(res.getDrawable(com.saarang.samples.apps.iosched.R.drawable.schedule_item_touchoverlay));
            ...
            slotTitleView.setTextColor(isBlockNow
                    ? Color.WHITE
                    : res.getColor(com.saarang.samples.apps.iosched.R.color.body_text_1_inverse));
            mLUtils.setMediumTypeface(slotTitleView);
            if (slotSubtitleView != null) {
                slotSubtitleView.setText(item.subtitle);
                slotSubtitleView.setTextColor(res.getColor(com.saarang.samples.apps.iosched.R.color.body_text_2_inverse));
            }
            view.setTag(com.saarang.samples.apps.iosched.R.id.myschedule_uri_tagkey,
                    ScheduleContract.Sessions.buildSessionUri(item.sessionId));
            ...
            if (!isPastDuringConference) {
                ...
                if (showConflict && !isNowPlaying) {
                    int conflictColor = res.getColor(com.saarang.samples.apps.iosched.R.color.my_schedule_conflict);
    ...
    public void updateItems(ArrayList<ScheduleItem> items) {
        ...
        if (items != null) {
            for (ScheduleItem item : items) {
                LogUtils.LOGD(TAG, "Adding schedule item: " + item + " start=" + new Date(item.startTime));
    ...
    public void onMovedToScrapHeap(View view) {
        if (view != null) {
            ImageView sessionImageView = (ImageView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_image);
