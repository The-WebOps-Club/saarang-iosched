...
import com.saarang.samples.apps.iosched.util.ParserUtils;
...
public class VideoLibraryFragment extends Fragment
    ...
    private static final String TAG = LogUtils.makeLogTag("VideoLibraryFragment");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_video_library, container, false);
        mCollectionView = (CollectionView) root.findViewById(com.saarang.samples.apps.iosched.R.id.videos_collection_view);
    ...
    public Loader<Cursor> onCreateLoader(int token, Bundle bundle) {
        if (token == VideosQuery._TOKEN) {
            ...
            LogUtils.LOGD(TAG, "Starting videos query, selection=" + selection + " (year=" + year
                    + ", topic=" + topic);
        ...
        LogUtils.LOGW(TAG, "Invalid query token: " + token);
        return null;
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (callbacks != null) {
            ...
            LogUtils.LOGW(TAG, "No callbacks to inform filters to. Video filtering will probably not work.");
        }
    }
    ...
    private void updateCollectionView() {
        LogUtils.LOGD(TAG, "Updating video library collection view.");
        CollectionView.InventoryGroup curGroup = null;
        CollectionView.Inventory inventory = new CollectionView.Inventory();
        mCursor.moveToPosition(-1);
        int dataIndex = -1;
        int normalColumns = getResources().getInteger(com.saarang.samples.apps.iosched.R.integer.video_library_columns);
        ...
        while (mCursor.moveToNext()) {
            ...
            String groupName = TextUtils.isEmpty(topic) ?
                    getString(com.saarang.samples.apps.iosched.R.string.google_i_o_year, year) : topic + " (" + year + ")";
    ...
    public View newCollectionItemView(Context context, int groupId, ViewGroup parent) {
        ...
        return inflater.inflate(com.saarang.samples.apps.iosched.R.layout.video_library_item, parent, false);
    }
    ...
    public void bindCollectionItemView(Context context, View view, int groupId,
        ...
        ImageView thumbnailView = (ImageView) view.findViewById(com.saarang.samples.apps.iosched.R.id.thumbnail);
        TextView titleView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.title);
        TextView speakersView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.speakers);
        TextView descriptionView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.description);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!TextUtils.isEmpty(youtubeLink)) {
                    LogUtils.LOGD(TAG, "Launching Youtube video: " + youtubeLink);
                    /* [ANALYTICS:EVENT]
