...
import com.saarang.samples.apps.iosched.provider.ScheduleContract.Sessions;
import com.saarang.samples.apps.iosched.ui.widget.SlidingTabLayout;
...
public class SessionLivestreamActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYouTubeFragment = (YouTubePlayerFragment)
                getFragmentManager().findFragmentById(com.saarang.samples.apps.iosched.R.id.livestream_player);
        ...
        mPlayerContainer = (LinearLayout) findViewById(com.saarang.samples.apps.iosched.R.id.livestream_player_container);
        ...
        mTabsContentLayout = (LinearLayout) findViewById(com.saarang.samples.apps.iosched.R.id.livestream_tabs_layout);

        // Set up ViewPager and adapter
        ViewPager viewPager = (ViewPager) findViewById(com.saarang.samples.apps.iosched.R.id.livestream_pager);
        viewPager.setOffscreenPageLimit(2);
        viewPager.setPageMargin(getResources().getDimensionPixelSize(com.saarang.samples.apps.iosched.R.dimen.page_margin_width));
        ...
        if (mIsTablet) {
            ...
            mVideoLayout = (LinearLayout) findViewById(com.saarang.samples.apps.iosched.R.id.livestream_video_layout);
        }
        ...
        SlidingTabLayout slidingTabLayout =
                (SlidingTabLayout) findViewById(com.saarang.samples.apps.iosched.R.id.livestream_sliding_tabs);
        slidingTabLayout.setCustomTabView(com.saarang.samples.apps.iosched.R.layout.tab_indicator, android.R.id.text1);
    ...
    private void reloadFromIntent(Intent intent) {
        ...
        if (youtubeUrl != null) {
            ...
            String actionBarTitle = getString(com.saarang.samples.apps.iosched.R.string.session_livestream_title);
                ...
                if (mIsFullscreen) {
                    if (mFullscreenCaptions.getVisibility() == View.GONE) {
                        ...
                        if (captionsFragment == null) {
                            ...
                            ft.add(com.saarang.samples.apps.iosched.R.id.fullscreen_captions, captionsFragment, TAG_CAPTIONS);
                            ft.commit();
                        }
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider,
        ...
        if (result.isUserRecoverableError()) {
            ...
            String errorMessage =
                    getString(com.saarang.samples.apps.iosched.R.string.session_livestream_error_init, result.toString());
    ...
    private int getActionBarHeightPx() {
        int[] attrs = new int[] { com.saarang.samples.apps.iosched.R.attr.actionBarSize };
    ...
    private class LivestreamAdapter extends CursorAdapter {
        ...
        public View newDropDownView(Context context, Cursor cursor, ViewGroup parent) {
            ...
            return mLayoutInflater.inflate(
                    com.saarang.samples.apps.iosched.R.layout.livestream_spinner_item_dropdown, parent, false);
        }

        @Override
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            // Inflate view that appears in the selected spinner
            return mLayoutInflater.inflate(com.saarang.samples.apps.iosched.R.layout.livestream_spinner_item_actionbar,
                    parent, false);
        }
    ...
    public static class SessionSummaryFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View view = inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_session_summary, null);
            mTitleView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_title);
            mAbstractView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_abstract);
            updateViews();
            return view;
        }
    ...
    public static class SessionCaptionsFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                Bundle savedInstanceState) {
            View view = inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_session_captions, null);
            mContainer = (FrameLayout) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_caption_container);
            if (!UIUtils.isTablet(getActivity())) {
                mContainer.setBackgroundColor(Color.WHITE);
            }
            mNoCaptionsTextView = (TextView) view.findViewById(android.R.id.empty);
            mWebView = (WebView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_caption_area);
