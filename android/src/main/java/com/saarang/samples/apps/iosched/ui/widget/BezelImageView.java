...
public class BezelImageView extends ImageView {
    ...
    public BezelImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.saarang.samples.apps.iosched.R.styleable.BezelImageView,
                defStyle, 0);
        ...
        mDesaturateOnPress = a.getBoolean(com.saarang.samples.apps.iosched.R.styleable.BezelImageView_desaturateOnPress,
                mDesaturateOnPress);
