...
package com.saarang.samples.apps.iosched.service;
...
import com.saarang.samples.apps.iosched.ui.BaseMapActivity;
import com.saarang.samples.apps.iosched.ui.BrowseSessionsActivity;
import com.saarang.samples.apps.iosched.ui.MyScheduleActivity;
import com.saarang.samples.apps.iosched.ui.SessionFeedbackActivity;
import com.saarang.samples.apps.iosched.util.FeedbackUtils;
...
public class SessionAlarmService extends IntentService
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "com.saarang.samples.apps.iosched.action.NOTIFY_SESSION";
    public static final String ACTION_NOTIFY_SESSION_FEEDBACK =
            "com.saarang.samples.apps.iosched.action.NOTIFY_SESSION_FEEDBACK";
    public static final String ACTION_SCHEDULE_FEEDBACK_NOTIFICATION =
            "com.saarang.samples.apps.iosched.action.SCHEDULE_FEEDBACK_NOTIFICATION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "com.saarang.samples.apps.iosched.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "com.saarang.samples.apps.iosched.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "com.saarang.samples.apps.iosched.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "com.saarang.samples.apps.iosched.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "com.saarang.samples.apps.iosched.extra.SESSION_ALARM_OFFSET";
    public static final String EXTRA_SESSION_ID =
            "com.saarang.samples.apps.iosched.extra.SESSION_ID";
    public static final String EXTRA_SESSION_TITLE =
            "com.saarang.samples.apps.iosched.extra.SESSION_TITLE";
    public static final String EXTRA_SESSION_ROOM =
            "com.saarang.samples.apps.iosched.extra.SESSION_ROOM";
    public static final String EXTRA_SESSION_SPEAKERS =
            "com.saarang.samples.apps.iosched.extra.SESSION_SPEAKERS";
    ...
    private void scheduleAlarm(final long sessionStart,
        ...
        notifIntent.setData(
                new Uri.Builder().authority("com.saarang.samples.apps.iosched")
    ...
    private void notifySessionFeedback(boolean debug) {
        ...
        String provideFeedbackTicker = res.getString(com.saarang.samples.apps.iosched.R.string.session_feedback_notification_ticker);
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, request)
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    ...
                    public void onResult(DataApi.DataItemResult dataItemResult) {
                        LogUtils.LOGD(TAG, "setupNotificationOnWear(): Sending notification result success:"
    ...
    private void notifySession(final long sessionStart, final long alarmOffset) {
        ...
        if (starredCount == 1) {
            contentText = res.getString(com.saarang.samples.apps.iosched.R.string.session_notification_text_1, minutesLeft);
        } else {
            contentText = res.getQuantityString(com.saarang.samples.apps.iosched.R.plurals.session_notification_text,
                    starredCount - 1,
                    minutesLeft,
                    starredCount - 1);
        }
        ...
        NotificationCompat.Builder notifBuilder = new NotificationCompat.Builder(this)
                ...
                .setColor(getResources().getColor(com.saarang.samples.apps.iosched.R.color.theme_primary))
                .setTicker(res.getQuantityString(com.saarang.samples.apps.iosched.R.plurals.session_notification_ticker,
                        starredCount,
                        starredCount))
                .setDefaults(Notification.DEFAULT_SOUND | Notification.DEFAULT_VIBRATE)
                .setLights(
        ...
        if (starredCount == 1 && starredSessionTitles.size() > 0) {
            ...
            bigContentTitle = res.getQuantityString(com.saarang.samples.apps.iosched.R.plurals.session_notification_title,
                    starredCount,
                    minutesLeft,
                    starredCount);
        }
