...
public class MapFragment extends com.google.android.gms.maps.MapFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_map, container, false);
        FrameLayout layout = (FrameLayout) v.findViewById(com.saarang.samples.apps.iosched.R.id.map_container);
