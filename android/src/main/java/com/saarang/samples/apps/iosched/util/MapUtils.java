...
public class MapUtils {
    ...
    public static MarkerOptions createSessionMarker(String id, String type, LatLng position) {
        int mark= R.drawable.marker_session;
        if(type.equals("session"))
            mark=R.drawable.marker_session;
        else if(type.equals("plainsession"))
            mark=R.drawable.marker_sandbox;

        final BitmapDescriptor icon =
                BitmapDescriptorFactory.fromResource(mark);
        return new MarkerOptions().position(position).title(id)
                .snippet(type).icon(icon).visible(true);
    }
    ...
    public static MarkerOptions createPartnerMarker(String id, LatLng position) {
        ...
        final BitmapDescriptor icon =
                BitmapDescriptorFactory.fromResource(com.saarang.samples.apps.iosched.R.drawable.marker_sandbox);
        return new MarkerOptions().position(position).title(id)
                .snippet(snippet).icon(icon).visible(true);
    }
