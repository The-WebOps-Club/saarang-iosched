...
import com.saarang.samples.apps.iosched.util.ThrottledContentObserver;
...
import static com.saarang.samples.apps.iosched.util.LogUtils.LOGV;
...
public class SessionsFragment extends Fragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDefaultSessionColor = getResources().getColor(com.saarang.samples.apps.iosched.R.color.default_session_color);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_sessions, container, false);
        mCollectionView = (CollectionView) root.findViewById(com.saarang.samples.apps.iosched.R.id.sessions_collection_view);
        mPreloader = new Preloader(ROWS_TO_PRELOAD);
        mCollectionView.setOnScrollListener(mPreloader);
        mEmptyView = (TextView) root.findViewById(com.saarang.samples.apps.iosched.R.id.empty_text);
        mLoadingView = root.findViewById(com.saarang.samples.apps.iosched.R.id.loading);
        return root;
    }
    ...
    private void showEmptyView() {
        ...
        if (mCurrentUri.equals(ScheduleContract.Sessions.CONTENT_URI)) {
            ...
            mEmptyView.setText(com.saarang.samples.apps.iosched.R.string.no_matching_sessions_in_interval);
            ...
            mEmptyView.setText(com.saarang.samples.apps.iosched.R.string.no_matching_sessions);
            mEmptyView.setVisibility(View.VISIBLE);
            mLoadingView.setVisibility(View.GONE);
        }
    }
    ...
    private CollectionView.Inventory prepareInventory() {
        ...
        final int displayCols = getResources().getInteger(expandedMode ?
                com.saarang.samples.apps.iosched.R.integer.explore_2nd_level_grid_columns : com.saarang.samples.apps.iosched.R.integer.explore_1st_level_grid_columns);
        ...
        while (mCursor.moveToNext()) {
            ...
            if (expandedMode) {
                ...
                if (groupTag != null) {
                    ...
                    groupLabel = getString(com.saarang.samples.apps.iosched.R.string.others);
                }
                groupLabel += (showAsPast ? " (" + getString(com.saarang.samples.apps.iosched.R.string.session_finished) + ")" : "");
            } else {
                groupLabel = showAsPast ? getString(com.saarang.samples.apps.iosched.R.string.ended_sessions) : "";
            }
    ...
    public View newCollectionHeaderView(Context context, ViewGroup parent) {
        ...
        return inflater.inflate(com.saarang.samples.apps.iosched.R.layout.list_item_explore_header, parent, false);
    }
    ...
    public View newCollectionItemView(Context context, int groupId, ViewGroup parent) {
        ...
        if (useExpandedMode()) {
            layoutId = com.saarang.samples.apps.iosched.R.layout.list_item_session;
        } else {
            // Group HERO_GROUP_ID is the hero -- use a larger layout
            layoutId = (groupId == HERO_GROUP_ID) ? com.saarang.samples.apps.iosched.R.layout.list_item_session_hero :
                    com.saarang.samples.apps.iosched.R.layout.list_item_session_summarized;
        }
    ...
    public void bindCollectionItemView(Context context, View view, int groupId, int indexInGroup, int dataIndex, Object tag) {
        ...
        sessionColor = sessionColor == 0 ? getResources().getColor(com.saarang.samples.apps.iosched.R.color.default_session_color)
                : sessionColor;
        ...
        final TextView titleView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_title);
        final TextView subtitleView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_subtitle);
        final TextView shortSubtitleView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_subtitle_short);
        final TextView snippetView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_snippet);
        final TextView abstractView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_abstract);
        final TextView categoryView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_category);
        ...
        if (mNoTrackBranding) {
            sessionColor = getResources().getColor(com.saarang.samples.apps.iosched.R.color.no_track_branding_session_color);
        }

        darkSessionColor = UIUtils.scaleSessionColorToDefaultBG(sessionColor);

        ImageView photoView = (ImageView) view.findViewById(com.saarang.samples.apps.iosched.R.id.session_photo_colored);
        if (photoView != null) {
            ...
            photoView.setColorFilter(mNoTrackBranding
                    ...
                    getResources().getColor(com.saarang.samples.apps.iosched.R.color.no_track_branding_session_tile_overlay),
        ...
        view.findViewById(com.saarang.samples.apps.iosched.R.id.indicator_in_schedule).setVisibility(starred ? View.VISIBLE
                : View.INVISIBLE);
        ...
        if (!useExpandedMode() && groupId == HERO_GROUP_ID) {
            ...
            final View cardContainer = view.findViewById(com.saarang.samples.apps.iosched.R.id.message_card_container_wide);
            final View abstractContainer = view.findViewById(com.saarang.samples.apps.iosched.R.id.session_abstract);
    ...
    private boolean setupMessageCard(View hero) {
        MessageCardView card = (MessageCardView) hero.findViewById(com.saarang.samples.apps.iosched.R.id.message_card);
        if (card == null) {
    ...
    private void setupLocalOrRemoteCard(final MessageCardView card) {
        card.setText(getString(com.saarang.samples.apps.iosched.R.string.question_local_or_remote));
        card.setButton(0, getString(com.saarang.samples.apps.iosched.R.string.attending_remotely), CARD_ANSWER_ATTENDING_REMOTELY,
                false, 0);
        card.setButton(1, getString(com.saarang.samples.apps.iosched.R.string.attending_in_person), CARD_ANSWER_ATTENDING_IN_PERSON,
                true, 0);
        ...
        card.setListener(new MessageCardView.OnMessageCardButtonClicked() {
            ...
            public void onMessageCardButtonClicked(final String tag) {
                ...
                if (activity != null) {
                    Toast.makeText(activity, inPerson ? com.saarang.samples.apps.iosched.R.string.explore_attending_in_person_toast
                            : com.saarang.samples.apps.iosched.R.string.explore_attending_remotely_toast, Toast.LENGTH_LONG).show();
                }
    ...
    private void setupWifiOfferCard(final MessageCardView card) {
        card.setText(getString(TimeUtils.hasConferenceStarted(getActivity()) ?
                com.saarang.samples.apps.iosched.R.string.question_setup_wifi_after_i_o_start :
                com.saarang.samples.apps.iosched.R.string.question_setup_wifi_before_i_o_start));
        card.setButton(0, getString(com.saarang.samples.apps.iosched.R.string.no_thanks), CARD_ANSWER_NO,
                false, 0);
        card.setButton(1, getString(com.saarang.samples.apps.iosched.R.string.setup_wifi_yes), CARD_ANSWER_YES,
                true, 0);
        final Context context = getActivity().getApplicationContext();
        card.setListener(new MessageCardView.OnMessageCardButtonClicked() {
            @Override
    ...
    private void setupIOExtendedCard(final MessageCardView card) {
        card.setText(getString(com.saarang.samples.apps.iosched.R.string.question_i_o_extended));
        card.setButton(0, getString(com.saarang.samples.apps.iosched.R.string.no_thanks), CARD_ANSWER_NO,
                false, 0);
        card.setButton(1, getString(com.saarang.samples.apps.iosched.R.string.browse_events), CARD_ANSWER_YES,
                true, 0);
        card.setListener(new MessageCardView.OnMessageCardButtonClicked() {
            @Override
            public void onMessageCardButtonClicked(final String tag) {
...
//        card.show();
    ...
    /**
     * {@link com.saarang.samples.apps.iosched.provider.ScheduleContract.Sessions}
     * query parameters.
     */
