...
//                    mActivity, clickedView, transitionName);
    ...
    public void compatSetOrAnimatePlusCheckIcon(final ImageView imageView, boolean isCheck,
        ...
        final int imageResId = isCheck
                ? com.saarang.samples.apps.iosched.R.drawable.add_schedule_button_icon_checked
                : com.saarang.samples.apps.iosched.R.drawable.add_schedule_button_icon_unchecked;
