...
public class ExpertsDirectoryFragment extends Fragment implements
    ...
    private static final String TAG = LogUtils.makeLogTag(ExpertsDirectoryFragment.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayCols = getResources().getInteger(com.saarang.samples.apps.iosched.R.integer.experts_directory_columns);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.saarang.samples.apps.iosched.R.layout.fragment_experts_directory, container, false);
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        switch (loader.getId()) {
            case ExpertsQuery.TOKEN: {
                LogUtils.LOGD(TAG, "Expert count: " + cursor.getCount());
    ...
    private class ExpertsAdapter extends CursorAdapter implements CollectionViewCallbacks {
        ...
        public ExpertsAdapter(Cursor cursor) {
            ...
            mCursor = cursor;
            mImageLoader = new ImageLoader(getActivity(), com.saarang.samples.apps.iosched.R.drawable.person_image_empty);
        }
        ...
        private CharSequence getBio(Cursor cursor) {
            ...
            if (0 != cursor.getLong(ExpertsQuery.EXPERT_ATTENDING)) {
                bio.append("<b>(");
                bio.append(getString(com.saarang.samples.apps.iosched.R.string.experts_directory_attending));
                bio.append(")</b>&nbsp;");
            }
        ...
        public CollectionView.Inventory getInventory() {
            ...
            inventory.addGroup(new CollectionView.InventoryGroup(ExpertsQuery.TOKEN)
                    ...
                    .setHeaderLabel(getString(com.saarang.samples.apps.iosched.R.string.title_experts_directory)));
            return inventory;
        }
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            ...
            View view = LayoutInflater.from(context).inflate(com.saarang.samples.apps.iosched.R.layout.list_item_expert, parent, false);
            assert view != null;
            ...
            holder.summary = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.summary);
            holder.bio = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.bio);
            view.setTag(holder);
            return view;
        }
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            view.findViewById(com.saarang.samples.apps.iosched.R.id.expert_target).setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        public View newCollectionHeaderView(Context context, ViewGroup parent) {
            return LayoutInflater.from(context).inflate(com.saarang.samples.apps.iosched.R.layout.header_experts_directory, parent, false);
        }

        @Override
        public void bindCollectionHeaderView(Context context, View view, int groupId, String headerLabel) {
            final MessageCardView messageCardView = (MessageCardView) view.findViewById(com.saarang.samples.apps.iosched.R.id.message_card);
