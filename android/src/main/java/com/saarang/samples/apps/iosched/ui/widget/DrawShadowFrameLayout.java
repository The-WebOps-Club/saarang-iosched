...
public class DrawShadowFrameLayout extends FrameLayout {
    ...
    public DrawShadowFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs,
                com.saarang.samples.apps.iosched.R.styleable.DrawShadowFrameLayout, 0, 0);

        mShadowDrawable = a.getDrawable(com.saarang.samples.apps.iosched.R.styleable.DrawShadowFrameLayout_shadowDrawable);
        ...
        mShadowVisible = a.getBoolean(com.saarang.samples.apps.iosched.R.styleable.DrawShadowFrameLayout_shadowVisible, true);
