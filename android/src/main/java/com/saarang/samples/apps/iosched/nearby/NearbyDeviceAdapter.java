...
public class NearbyDeviceAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup container) {
        if (view == null) {
            view = mActivity.getLayoutInflater().inflate(com.saarang.samples.apps.iosched.R.layout.ble_listitem_device, null);
        }
        ...
        infoView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.title);
        if (deviceMetadata != null) {
            ...
            infoView.setText(com.saarang.samples.apps.iosched.R.string.loading);
            infoView.setVisibility(View.VISIBLE);
        }

        infoView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.url);
        if (deviceMetadata != null) {
        ...
        infoView = (TextView) view.findViewById(com.saarang.samples.apps.iosched.R.id.description);
        if (deviceMetadata != null) {
        ...
        if (deviceMetadata != null) {
            ...
            iconView.setImageResource(com.saarang.samples.apps.iosched.R.drawable.empty_nearby_icon);
        }
