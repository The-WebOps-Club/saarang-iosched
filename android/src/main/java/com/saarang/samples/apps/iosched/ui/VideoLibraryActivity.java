...
public class VideoLibraryActivity extends BaseActivity implements VideoLibraryFragment.Callbacks {
    ...
    private static final String STATE_KEY_YEAR = "com.saarang.samples.apps.iosched.STATE_KEY_YEAR";
    private static final String STATE_KEY_TOPIC = "com.saarang.samples.apps.iosched.STATE_KEY_TOPIC";
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        enableActionBarAutoHide((CollectionView) findViewById(com.saarang.samples.apps.iosched.R.id.videos_collection_view));
    }
...
*/
    ...
    protected void onResume() {
        ...
        Fragment frag = getFragmentManager().findFragmentById(com.saarang.samples.apps.iosched.R.id.videos_fragment);
        if (frag != null) {
    ...
    public void onAvailableVideoYearsChanged(ArrayList<Integer> years) {
        ...
        Spinner yearsSpinner = (Spinner) findViewById(com.saarang.samples.apps.iosched.R.id.video_filter_spinner_year);
        mYears.clear();
        ...
        if (yearsSpinner != null) {
            ...
            items.add(getString(com.saarang.samples.apps.iosched.R.string.all_years));
            ...
            for (int year : years) {
                items.add(getString(com.saarang.samples.apps.iosched.R.string.google_i_o_year, year));
                mYears.add(year);
    ...
    public void onAvailableVideoTopicsChanged(ArrayList<String> availableTopics) {
        ...
        Spinner topicsSpinner = (Spinner) findViewById(com.saarang.samples.apps.iosched.R.id.video_filter_spinner_topic);
        mTopics.clear();
        if (topicsSpinner != null) {
            ArrayList<String> items = new ArrayList<String>();
            int positionToSelect = -1;
            items.add(getString(com.saarang.samples.apps.iosched.R.string.all_topics));
    ...
    private void populateSpinner(Spinner spinner, ArrayList<String> items) {
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, com.saarang.samples.apps.iosched.R.layout.explore_spinner_item,
                android.R.id.text1, items);
        adapter.setDropDownViewResource(com.saarang.samples.apps.iosched.R.layout.video_library_spinner_item_dropdown);
