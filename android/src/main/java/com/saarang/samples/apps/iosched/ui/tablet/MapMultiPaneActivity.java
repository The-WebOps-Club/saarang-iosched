...
package com.saarang.samples.apps.iosched.ui.tablet;
...
import com.saarang.samples.apps.iosched.ui.MapFragment;
import com.saarang.samples.apps.iosched.ui.NearbyFragment;
import com.saarang.samples.apps.iosched.ui.PartnersFragment;
import com.saarang.samples.apps.iosched.ui.SessionDetailActivity;
import com.saarang.samples.apps.iosched.ui.SessionsFragment;
...
public class MapMultiPaneActivity extends BaseMapActivity implements
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        LinearLayout spacerView = (LinearLayout) findViewById(com.saarang.samples.apps.iosched.R.id.map_detail_spacer);
        ...
        View popupView = findViewById(com.saarang.samples.apps.iosched.R.id.map_detail_popup);
        ...
        popupLayoutParams.topMargin =
                getResources().getDimensionPixelSize(com.saarang.samples.apps.iosched.R.dimen.multipane_half_padding) +
    ...
    private void showDetailPane(boolean show) {
        View detailPopup = findViewById(com.saarang.samples.apps.iosched.R.id.map_detail_spacer);
    ...
    private void updateMapPadding() {
        ...
        boolean detailShown = findViewById(com.saarang.samples.apps.iosched.R.id.map_detail_spacer).getVisibility() == View.VISIBLE;
    ...
    public void onShowPartners() {
        ...
        getFragmentManager().beginTransaction()
                .replace(com.saarang.samples.apps.iosched.R.id.fragment_container_detail, PartnersFragment.newInstance(false))
                .setBreadCrumbTitle(com.saarang.samples.apps.iosched.R.string.partners)
                .setBreadCrumbShortTitle(com.saarang.samples.apps.iosched.R.string.partners)
                .addToBackStack(null)
                .commit();
        updateBreadCrumbs();
    }
    ...
    protected void showNearbyFragment(String tag) {
        showDetailPane(true);
        getFragmentManager().beginTransaction()
                .replace(com.saarang.samples.apps.iosched.R.id.fragment_container_detail, NearbyFragment.newInstance(false), tag)
                .setBreadCrumbTitle(com.saarang.samples.apps.iosched.R.string.map_nearby_button)
                .setBreadCrumbShortTitle(com.saarang.samples.apps.iosched.R.string.map_nearby_button)
                .addToBackStack(null)
                .commit();
    }
}
