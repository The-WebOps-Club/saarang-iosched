...
public class SocialActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.saarang.samples.apps.iosched.R.layout.activity_social);

        if (null == savedInstanceState) {
            getFragmentManager().beginTransaction()
                    .replace(com.saarang.samples.apps.iosched.R.id.container, HashtagsFragment.newInstance())
                    .commit();
        }
