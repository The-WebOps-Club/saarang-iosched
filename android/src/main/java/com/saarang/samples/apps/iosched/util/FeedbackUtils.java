...
import com.saarang.samples.apps.iosched.service.FeedbackListenerService;
...
public class FeedbackUtils {
    ...
    private static final String TAG = LogUtils.makeLogTag(FeedbackUtils.class);
    ...
    public static void saveSessionFeedback(Context context, String sessionId, int rating,
        ...
        LogUtils.LOGD(TAG, null == uri ? "No feedback was saved" : uri.toString());
