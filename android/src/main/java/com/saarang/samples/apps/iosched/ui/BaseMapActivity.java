...
import com.saarang.samples.apps.iosched.nearby.MetadataResolver;
import com.saarang.samples.apps.iosched.nearby.NearbyDeviceManager;
import com.saarang.samples.apps.iosched.ui.widget.ScrimInsetsFrameLayout;
...
public abstract class BaseMapActivity extends BaseActivity implements NearbyFragment.Callbacks, ScrimInsetsFrameLayout.OnInsetsCallback {
    private static final String TAG = LogUtils.makeLogTag(BaseMapActivity.class);
    ...
    public static final String EXTRA_DETACHED_MODE
            = "com.saarang.samples.apps.iosched.EXTRA_DETACHED_MODE";
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (mMapFragment == null) {
            ...
            getFragmentManager().beginTransaction()
                    .add(com.saarang.samples.apps.iosched.R.id.fragment_container_map, mMapFragment, "map")
                    .commit();
        }
        ...
        ScrimInsetsFrameLayout scrimInsetsFrameLayout = (ScrimInsetsFrameLayout)
                findViewById(com.saarang.samples.apps.iosched.R.id.capture_insets_frame_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        /*if (mNearbyCapable) {
            getMenuInflater().inflate(com.saarang.samples.apps.iosched.R.menu.nearby, menu);
            MenuItem nearbyItem = menu.findItem(com.saarang.samples.apps.iosched.R.id.menu_nearby);
            mNearbyButton =
                    (Button) nearbyItem.getActionView().findViewById(com.saarang.samples.apps.iosched.R.id.nearby_action_button);
    ...
    private void updateNearbyButton() {
        ...
        final String text = (count == 0 ? "" : (String.valueOf(count) + " "))
                + getResources().getString(com.saarang.samples.apps.iosched.R.string.map_nearby_button);
