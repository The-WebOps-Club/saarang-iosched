...
public class ScrimInsetsScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a = context.obtainStyledAttributes(attrs,
                com.saarang.samples.apps.iosched.R.styleable.ScrimInsetsView, defStyle, 0);
        if (a == null) {
            return;
        }
        mInsetForeground = a.getDrawable(com.saarang.samples.apps.iosched.R.styleable.ScrimInsetsView_insetForeground);
        a.recycle();
