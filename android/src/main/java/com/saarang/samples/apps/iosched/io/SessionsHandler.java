...
package com.saarang.samples.apps.iosched.io;
...
import com.saarang.samples.apps.iosched.io.model.Session;
import com.saarang.samples.apps.iosched.io.model.Speaker;
import com.saarang.samples.apps.iosched.io.model.Tag;
import com.saarang.samples.apps.iosched.provider.ScheduleContract;
import com.saarang.samples.apps.iosched.provider.ScheduleDatabase;
        ...
        if (mSpeakerMap != null) {
            ...
            for (int i = 0; i < session.speakers.length; ++i) {
                if (mSpeakerMap.containsKey(session.speakers[i])) {
                    ...
                    LogUtils.LOGW(TAG, "Unknown speaker ID " + session.speakers[i] + " in session " + session.id);
                }
            }
